...
function initClient()
{
    ...
    gapi.client.init({
        ...
        //'scope': SCOPE
        'apiKey': 'AIzaSyBtL5lsaPUzeH6dhYIW9vgJ1pkURlPmBFM',
        'discoveryDocs': [discoveryUrl],
        'clientId': '829651188662-5c3aimup0glid2kub9fo7655hp8dnair.apps.googleusercontent.com',
        'scope': SCOPE
    }).then(function () {
...
function getAccessTokenGmail(username) {
    console.log("Access token of "+userUrl);
    $.ajax
    (
        {
            type: "GET",
